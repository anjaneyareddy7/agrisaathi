...
export const APP_ROUTES = [
  ...
  { path: '/resource-marketplace', label: 'Resource Marketplace',
  ...
  { path: '/weather-alerts', label: 'Weather',
    description: 'See live weather, forecast, and severe-weather alerts for your farm location.',
